 ...
 * It sets up the React application with routing and context providers.
 */
...
// Create index.html with client-side code
const createIndexHtml = () => {
  ...
  // Define the HTML template with client-side React
...
// Create the index.html file when the server starts
createIndexHtml();

// Define routes - all routes will serve the same React app
app.get('*', (req, res) => {
