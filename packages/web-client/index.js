...
<body>
  ...
  <script type="text/babel">
        ...
        try {
          ...
          return { 
            reports: [
              ...
              {
                id: 2,
                report_number: 'CA-2025-001',
                status: 'in_review',
                created_at: new Date().toISOString(),
                property_id: 2,
                title: 'Commercial Appraisal - 456 Market St',
              ...
              },
              {
                ...
                created_at: new Date().toISOString(),
                property_id: 3,
                title: 'Residential Appraisal - 789 Oak Ave',
                client_name: 'Jane Doe'
              },
              {
                id: 4,
                report_number: 'IA-2025-001',
                status: 'finalized',
                created_at: new Date().toISOString(),
                property_id: 4,
                title: 'Industrial Appraisal - 101 Tech Blvd',
    ...
    const Header = () => {
      const { currentUser, isAuthenticated, logout } = React.useContext(AuthContext);
      const navigate = useNavigate();
            ...
            <nav className="nav-links">
              {isAuthenticated ? (
                <>
                  ...
                  <span>Welcome, {currentUser?.first_name || currentUser?.name || 'User'}</span>
          ...
          <div className="container">
            <div className="footer-content">
              <div className="footer-section">
                ...
                <p>Advanced real estate appraisal platform with cutting-edge analytics.</p>
              </div>
              <div className="footer-section">
                <h3>Quick Links</h3>
                <ul className="footer-links">
      ...
      return (
        <div className="dashboard-container">
          ...
          <div className="dashboard">
            <div className="card">
              <h2>Recent Properties</h2>
              <p>View and manage your property inventory</p>
              <Link to="/properties" className="btn btn-primary">View All</Link>
            </div>
            <div className="card">
              <h2>Active Reports</h2>
              <p>Manage your active appraisal reports</p>
              <Link to="/reports" className="btn btn-primary">View Reports</Link>
            </div>
            <div className="card">
              <h2>Market Analysis</h2>
              <p>Review market trends and analytics</p>
              <Link to="/market-analysis" className="btn btn-primary">View Analysis</Link>
            </div>
          </div>
        </div>
      );
    ...
    // Add a PrivateRoute component to protect routes
    const PrivateRoute = ({ children }) => {
